...
createdBy.innerHTML += " Angel Ramirez"; 
...
// Comprobando con pruebas------------------------------------------------------
// let prueba = new ToDo("tarea")
// console.log(buildToDo(prueba, 1))
// -----------------------------------------------------------------------------
...
function buildToDos(toDos) {
  // Tu código acá:
  return toDos.map((item, index) => buildToDo(item, index))
}
